...
education   = c(0.05, 0.05, 0.05)     #potential increased in the knowledge parameter for each individual annually, by demo group
ed.who      = "all"                #who is educated: locals or all
...
local_local.A = c(1,1,0.5)           #interaction adjustment for each group, within demographic groups
