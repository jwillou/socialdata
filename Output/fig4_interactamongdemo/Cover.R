...
tours_local.P = 0.05               #likelihood of interacting within the year, within demographic groups
...
local_misd.P  = seq(0.0,0.5,0.1)   #likelihood of interacting within the year, among demographic groups
