...
#Knowledge transmission variations
knowtrans.P = seq(0,0.5,0.05)      #overrides above, amount of knowledge transfer possible at interactions default 0.05
...
tours_tours.P = 0.1#seq(0.1,0.1,0.1)   #likelihood of interacting within the year, among and within demographic groups
...
local_misd.P  = 0.0#seq(0.0,0.0,0.0)   #likelihood of interacting within the year, among demographic groups
