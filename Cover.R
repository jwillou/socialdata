...
knowtrans = 0.1                    #amount of knowledge transfer possible with at interactions
...
tours_tours.P = 0.1                #likelihood of interacting within the year, within demographic groups
...
for(r in 1:nrow(parameters)){
  RunModel(r, directory, demo.locals, demo.tours, num_locals, num_tours, years, scenarios)
}
